...
const banner = figlet.textSync('V - TOOLS', {
    font: 'Slant',
...
${chalk.green('[')}${chalk.white('+')}${chalk.green(']')} ${chalk.yellowBright('Tools Created By X - Nabil354')}
${chalk.green('')}${chalk.white('Support')}${chalk.green(':')} ${chalk.yellowBright('Thanks TO RPL x TKJ Team')}
${chalk.green('')}${chalk.white('!')}${chalk.green('')} ${chalk.yellowBright('WARNING! Used Your Own Risk :(')}

${chalk.bgRedBright('SELECT ANY TOOLS FOR YOUR VICTIM')}:

${chalk.red('[')}${chalk.whiteBright('0')}${chalk.red(']')} ${chalk.yellowBright('INFO')}
...
switch (user_input) {
    case "00":
        ...
        break
    case "0": 
        print("My Name : Nabil Hafiyyan Zihni Muktiono\nMy Whatsapp : https://wa.me/6281281524356\nMy Instagram : https://www.instagram.com/nblhnzm354/\nMy Facebook : https://www.facebook.com/nabil.voel.73/\nMy Twitter : https://twitter.com/nabil3544\nMy Github : https://github.com/nabilhnzm354\nMy Telegram : https://t.me/Nblhnzm354\nMy Rest Api : https://nabilapi354.herokuapp.com/\nMy Website : https://nabil354.xyz\nMy WhatsappBot : https://wa.me/62881026470535\nDon't Forget To Follow My Social Media For Support Me Thankss :)")
        process.exit();
        break
    case "1":
